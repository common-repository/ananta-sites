...
if (!function_exists('compileStyle')):
        ...
        $allCss = array_reduce(array_keys($type), function($css, $property) use ($type) {
            ...
            if ($property === 'padding') {
                ...
                if ( ($value['colorOpt'] === 'color') &&!empty($value['colorOne']['color']) && ($value['colorOne']['color'] !== 'undefined' ) ) {
                    $dualColor = "background-color: {$value['colorOne']['color']} !important; ";
                    ...
                    if( ($value['type'] === 'linear-gradient') && !empty($value['colorOne']['color']) && ($value['colorOne']['color'] !== 'undefined' ) && !empty($value['colorTwo']['color']) && ($value['colorTwo']['color'] !== 'undefined' ) ){
                        $dualColor = "background-color: transparent !important; background-image: linear-gradient({$value['angle']}deg, {$value['colorOne']['color']} {$value['locationOne']}%, {$value['colorTwo']['color']} {$value['locationTwo']}%) !important; ";
                        ...
                        $dualColor = "background-color: transparent !important; background-image: radial-gradient(at {$value['position']}, {$value['colorOne']['color']} {$value['locationOne']}%, {$value['colorTwo']['color']} {$value['locationTwo']}%) !important; ";
                    }
                }
